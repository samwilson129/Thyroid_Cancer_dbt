At present this repository consists of a thyroid cancer relational database implemented through mysql with 212692 for each table and 5 tables along with a python backend to interact with the database.
